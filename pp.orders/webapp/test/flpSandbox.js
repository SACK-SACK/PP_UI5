		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "생산오더 승인",
									"targetURL": "#synccapppporders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccapppporders-display": {
								"semanticObject": "synccapppporders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.pp.pp.orders",
									"url": sap.ui.require.toUrl("sync/ca/pp/pp/orders")
								}
							}
						}
					}
