		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "생산 현황 조회",
									"targetURL": "#synccappppproduction-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccappppproduction-display": {
								"semanticObject": "synccappppproduction",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.pp.pp.production",
									"url": sap.ui.require.toUrl("sync/ca/pp/pp/production")
								}
							}
						}
					}
