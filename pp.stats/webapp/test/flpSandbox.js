		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "생산실적 차트 및 통계",
									"targetURL": "#synccappppstats-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccappppstats-display": {
								"semanticObject": "synccappppstats",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.pp.pp.stats",
									"url": sap.ui.require.toUrl("sync/ca/pp/pp/stats")
								}
							}
						}
					}
