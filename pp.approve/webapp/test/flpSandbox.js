		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "생산계획 승인 프로그램",
									"targetURL": "#synccappppapprove-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccappppapprove-display": {
								"semanticObject": "synccappppapprove",
								"action": "display",
								"description": "생산계획 승인 프로그래",
								"title": "생산계획 승인 프로그램",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.pp.pp.approve",
									"url": sap.ui.require.toUrl("sync/ca/pp/pp/approve")
								}
							}
						}
					}
